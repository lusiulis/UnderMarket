    ...
    <View style={CommonSyles.mainContainer}>
      ...
      <View style={styles.form}>
          ...
          <View style={styles.inputsContainer}>
            ...
            <Input value={formData.password} placeHolder='Contraseña' secure icon='lock' onChange={value => handleInputChange(value, 'password')} />
            <Input value={formData.confirmPassword} placeHolder='Confirmar Contraseña' secure icon='lock' onChange={value => handleInputChange(value, 'confirmPassword')} />
            {isStore && <Input value={formData.phoneNumber} placeHolder='Número de Telefono' icon='phone' onChange={value => handleInputChange(value, 'phoneNumber')} />}
          </View>
